...
// The new Featured Projects grid with align="left"
...
// Replace Achievements Block securely
const achievementsHeader = '## <img src="https://media.giphy.com/media/l0ExhcMymdL6TrZ84/giphy.gif" width="28"> Achievements & Hackathons\\s*<div align="center">\\s*';
const featuredHeader = '## 🏗️ Featured Projects\\s*<div align="center">\\s*';

// Construct dynamic regexes that capture everything up to the first </div>
const r1 = new RegExp(achievementsHeader + '<table[\\s\\S]*?</table>', 'm');
content = content.replace(r1, '## <img src="https://media.giphy.com/media/l0ExhcMymdL6TrZ84/giphy.gif" width="28"> Achievements & Hackathons\n\n<div align="center">\n\n' + newAchievements);

const r2 = new RegExp(featuredHeader + '<table[\\s\\S]*?</table>\\s*</div>\n\n<br/>', 'm');
content = content.replace(r2, '## 🏗️ Featured Projects\n\n<div align="center">\n\n' + newFeaturedProjects + '\n\n</div>\n\n<br/>');

fs.writeFileSync('README.md', content);
console.log('Successfully rewrote layout directly without Regex matching bugs.');
